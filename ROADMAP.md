...
| 2026-07-30 | Advanced `R8-04`: TypeScript validation now matches the deterministic Python safety gates for source freshness/conflicts, document chains and quality, action receipts/decisions, appointments, and readiness age. Native negative-fixture tests and contract checks pass; migration and deterministic reports remain to be ported. |
