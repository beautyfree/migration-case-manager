...
- `arrival_90d`: review tax/reporting, permit renewal, longer housing, and resilience decisions against refreshed sources.
- `stabilize`: transition recurring obligations and expired temporary work into the ordinary case review cadence.
